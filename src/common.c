...
// Global buffer for address string representation
...
// Address utility functions implementation
...
// SRT packet analysis functions implementation
...
// SRTLA packet analysis functions implementation
int is_srtla_keepalive(void *pkt, int len) {
    return get_srt_type(pkt, len) == SRTLA_TYPE_KEEPALIVE;
}
